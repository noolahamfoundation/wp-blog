...
<li>
<?php 
	$ban1 = get_option('ktn_banner1'); 
	$url1 = get_option('ktn_url1'); 
?>
...
<li>
<?php 
	$ban2 = get_option('ktn_banner2'); 
	$url2 = get_option('ktn_url2'); 
	?>
...
<li>
<?php 
	$ban3 = get_option('ktn_banner3'); 
	$url3 = get_option('ktn_url3'); 
	?>
...
<li>
<?php 
	$ban4 = get_option('ktn_banner4'); 
	$url4 = get_option('ktn_url4'); 
	?>
